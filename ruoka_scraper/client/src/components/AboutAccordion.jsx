...
const AboutAccordion = ({ title, text }) => {
  ...
  return (
    <div>
        <button className="py-2 pl-2 text-gray-500 flex items-center cursor-pointer" onClick={() => setSectionOpen(!sectionOpen)}>
          {title}
          {sectionOpen ? <GoTriangleUp size={18} /> : <GoTriangleDown size={18} /> }
        </button>
